...
import { SponsorTierPublicController } from './sponsor-tier-public.controller';
...
@Module({
  ...
  controllers: [
    ...
    PublicSponsorController,
    SponsorTierAdminController,
    SponsorTierPublicController,
  ],
  exports: [SponsorService, SponsorPackageService, SponsorTierService],
})
